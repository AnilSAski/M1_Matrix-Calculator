...
int main()
{
    ...
    while (1)
    {
     ...
     printf("3. Compute Medium Transmission(T model) Line parameters\n"); 
     printf("4. Compute LongTransmission Line parameters\n");
     printf("5. Exit\n");
     ...
     switch (line)
     {
        ...
        case 2:
                ...
                scanf("%d",&len);
                ptr=mediumPiLine(rcv_pow,rcv_vol,pf,res,inductor,cap,len);
                printf("...Sending end Voltage is %.3lf+i%.3lfVolts\n",*ptr,*(ptr+1));
                ...
                break;
        case 3:
                printf("........Computing Medium Transmission Line Parameters(Nominal T model)........\n");
                printf("\nEnter the Resistance of Transmission Line per km: ");
                scanf("%lf",&res);
                printf("\nEnter the Inductance of the Transmission Line per km: ");
                scanf("%lf",&inductor);
                ...
                printf("\nEnter the length of the Transmission Line: ");
                scanf("%d",&len);
                ptr=mediumTLine(rcv_pow,rcv_vol,pf,res,inductor,cap,len);
                printf("...Sending end Voltage is %.3lf+i%.3lfVolts\n",*ptr,*(ptr+1));
                printf("...Sending end Current is %.3lf+i%.3lfAmperes\n",*(ptr+2),*(ptr+3));
                printf("...Sending end Power Factor is %.3lf\n",*(ptr+4));
                printf("...The efficieny of Medium transmission Line is %.3lf\n",*(ptr+5));
        ...
        case 5:
                ...
                break;
        default : 
                        printf("Please choose the correct line\n");
                        break;
     }  
    }
}